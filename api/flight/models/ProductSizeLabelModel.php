...
class ProductSizeLabelModel
{
    ...
    public function getAll(): array
    {
        try {
            ...
            ErrorHandler::handleException($e, __METHOD__, "ProductSizeLabelModel->getAll()");
        }
    }
    ...
    public function create(string $name, string $label): ?int
    {
        try {
            ...
            ErrorHandler::handleException($e, __METHOD__, "ProductSizeLabelModel->create()");
        }
    }
    ...
    public function delete($id)
    {
        try {
            ...
            ErrorHandler::handleException($e, __METHOD__, "ProductSizeLabelModel->delete()");
        }
    }
}
